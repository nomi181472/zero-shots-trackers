...
const TRACKERS = ["bytetrack", "sort", "iou"];
...
export default function Home() {
  ...
  const start = useCallback(async () => {
    ...
    try {
      ...
      trackThresh, matchThresh, trackBuffer, showTrails, loop]);
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(t);
      ...
      matchThresh, trackBuffer, showTrails, loop]);
  ...
  return (
    <main>
      <h1>Zero-Shot Tracking</h1>
      <p className="sub">
        GroundingDINO detects whatever your text says; ByteTrack / SORT / IoU
        track it live. Upload a clip or point it at an RTSP camera, then switch
        trackers while it runs.
      </p>
